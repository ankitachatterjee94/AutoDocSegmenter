...
DATA_DIR = '/home/ankitaC/Ankita/Microsoft/data/prima'

x_val_dir = os.path.join(DATA_DIR, 'val')
y_val_dir = os.path.join(DATA_DIR, 'results_gt_prima')
...
model.load_state_dict(torch.load('model_best_mobilenetv3_small_100.pth.tar')['state_dict'])

i = 0.5
while i<=0.95:
    file = open('results/logfile_prima_mobilenetv3_small_' + str(i) + '.txt', 'a')
    sys.stdout = file
